...
/* harmony import */ var _modules_slider_forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/slider/forms */ "./src/js/modules/slider/forms.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  new _modules_slider_forms__WEBPACK_IMPORTED_MODULE_4__["default"]('.form').init();
});
...
/***/ "./src/js/modules/slider/forms.js":
/*!****************************************!*\
  !*** ./src/js/modules/slider/forms.js ***!
  \****************************************/
/*! exports provided: default */
      ...
      this.forms.forEach(function (form) {
        form.addEventListener('submit', function (e) {
          ...
          _this.postData(_this.path, formData).then(function (res) {
            ...
            statusMessage.textContent = _this.message.failrue;
          }).finally(function () {
            _this.clearInputs();
    ...
    value: function bindTriggers() {
      ...
      this.prev.addEventListener('click', function () {
        if (_this2.slides[_this2.slides.length - 1].tagName == 'BUTTON' && _this2.slides[_this2.slides.length - 2].tagName == 'BUTTON') {
          ...
          var _active = _this2.slides[_this2.slides.length - 1];
